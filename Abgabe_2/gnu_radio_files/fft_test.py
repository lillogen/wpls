...
class fft_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 640
        self.fft_size = fft_size = 640

        ##################################################
        # Blocks
        ##################################################
        self._fft_size_range = Range(10, 1000, 10, 640, 200)
        self._fft_size_win = RangeWidget(self._fft_size_range, self.set_fft_size, 'fft_size', "counter_slider", float)
        self.top_grid_layout.addWidget(self._fft_size_win)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, '/tmp/trash.bin', False, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(320, self.samp_rate)
