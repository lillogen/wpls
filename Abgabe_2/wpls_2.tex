...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{Dateien/Aufgabe_2/Bilder/donald.png} 
\caption{Spectrum Bilder 2.0}
\label{fig:2_2}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{Dateien/Aufgabe_2/Bilder/finger.png} 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Dateien/Aufgabe_3/Figure_1.png} 
