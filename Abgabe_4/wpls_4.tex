...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{Bilder/attacktree.jpeg}
...
\begin{figure}[H]
\centering
\subfloat[25 cm]{\includegraphics[width=0.4\textwidth]{Bilder/Abstand25.jpg}} \qquad
\subfloat[5 cm]{\includegraphics[width=0.4\textwidth]{Bilder/Abstand5.jpg}}
...
\begin{figure}[H]
\centering
\subfloat[25 cm Abstand E <-> B]{\includegraphics[width=0.4\textwidth]{Messungen/Repetition_1_25cm/output_Ex4/correlation_AE.png}} \qquad
\subfloat[5 cm Abstand E <-> B]{\includegraphics[width=0.4\textwidth]{Messungen/Repetition_1_25cm/output_Ex4/correlation_AE.png}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Messungen/Predictions_Atk_Zuhause/output_Ex4/measurement_shortened.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{Messungen/Predictions_Atk_Zuhause/output_Ex4/correlation_AE.png}
\caption{RSSI Verlauf der Messwerte aus dem Prediction Angriff}
\label{fig:p2}
\end{figure}
...
\begin{figure}[H]
\centering
\subfloat[Quant 1]{\includegraphics[width=0.4\textwidth]{Messungen/Predictions_Atk_Zuhause/output_Ex4/ber_AB_Quant_1.png} } \qquad
\subfloat[Quant 1]{\includegraphics[width=0.4\textwidth]{Messungen/Predictions_Atk_Zuhause/output_Ex4/ber_AE_Quant_1.png} }
\caption{BER Quantisierer 1 Prediction Atk}
\label{fig:p3}
\end{figure}
\begin{figure}[H]
\centering
\subfloat[Quant 2]{\includegraphics[width=0.4\textwidth]{Messungen/Predictions_Atk_Zuhause/output_Ex4/ber_AB_Quant_2.png} } \qquad
\subfloat[Quant 2]{\includegraphics[width=0.4\textwidth]{Messungen/Predictions_Atk_Zuhause/output_Ex4/ber_AE_Quant_2.png} }
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Messungen/EIGENER_Angriff/output_Ex4/measurement_shortened.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Messungen/EIGENER_Angriff/output_Ex4/correlation_AE.png}
...
\begin{figure}[H]
\centering
\subfloat[]{\includegraphics[width=0.4\textwidth]{Messungen/eigenerAngriff_2/output_Ex4/correlation_AE.png} } \qquad
\subfloat[]{\includegraphics[width=0.4\textwidth]{Messungen/eigener_Angriff_1/output_Ex4/correlation_AE.png} }
