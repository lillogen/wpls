...
\subsection*{a)}
Die Authoren wollen ein mathematisches Modell eines 'Kanal untersuchungs Systems' aufstellen und den Zusammenhang zwischen Biterzeugungsrate und Kanaluntersuchungsrate herstellen. (hört sich auf deutsch ein bisschen blöd an :D). Sie wollen des weiteren anhand der Entropie die Biterzeugungsrate ableiten
\end{document}